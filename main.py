...
time.sleep (1.5)
print("Lazlo's signuture","\U0001f4a9")
time.sleep (1.5)

sessionover = False
hav_username = input("Do you have a username?(y,n) ")
if hav_username == "y":
  # authenticate user
  auth = 0
  ...
  if auth:
    bot_list = {1:'Daisy',2:'Juli',3:'Tao',4:'Zoe W',5:'Pax',6:'Lachlan', 7:'John', 8:'Shaila', 9:'mystery', 10:'Ellis', 11:'DLBros', 12:'fifer', 13:'RandomBot', 14:'Ryth', 15:'Camila',16:'Kai'}
    user = username
    for _ in range(1):
      try:
        if authuser == "DLBros":
